...
abstract base class PrimitiveColors {
  ...
  final Color _barokat = const Color(0xFF073D3D);

  Color get textBrand => _barokat;

  Color get iconBrand => _barokat;

  Color get borderBrand => _barokat;

  final Color _alifIndended = const Color(0xff5594F2);

  Color get surfaceBrandIndended => _alifIndended;

  Color get surfaceBrand => _barokat;
